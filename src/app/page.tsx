...
import { ClassifiedsMarketingHome } from '@/components/home/classifieds-marketing-home'
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {productKind === 'directory' ? <ClassifiedsMarketingHome classifiedPosts={classifiedPosts} /> : null}
